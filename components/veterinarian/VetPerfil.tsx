  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[typography.h2, styles.nameTitle]}>Dr. {profile?.name}</Text>
        <Text style={styles.roleSubtitle}>Veterinario de VetCare</Text>
      </View>
        ...
        <>
          ...
          <Card>
            <View style={styles.sectionHeader}>
              <Text style={[typography.h3, { color: colors.primary }]}>Información Profesional</Text>
            </View>
